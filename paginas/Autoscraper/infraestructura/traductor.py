...
class PatioTuercaRecordTranslator:
    ...
    def build_csv_row(self, e: Dict[str, Any]) -> Dict[str, Any]:
        ...
        row = {
            ...
            "climateSystem":_norm_str(_pick(data, "Sistema de climatización", default="ND"), default="ND"),
            "ciudad": _norm_str(_pick(data, "Ciudad", "city", default="ND"), default="ND"),

            "color": _norm_str(_pick(data, "Color", default="ND"), default="ND"),
            "motor": _norm_str(_pick(data, "Motor(cilindraje)", "engine","Cilindraje", default="ND"), default="ND"),
            ...
            "motorType": _norm_str(_pick(data, "Tipo de motor","Tipo de Motor", default="ND"), default="ND"),
